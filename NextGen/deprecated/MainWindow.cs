...
namespace YAMP
{
    public partial class MainWindow : Form
    {
        ...
        {
            switch (plEdit.Visible)
            {
                case false: plEdit.Show(); break;
                case true: plEdit.Hide(); break;
            }
        ...
        private void MainWindow_ClientSizeChanged(object sender, EventArgs e)
        {
            if (plEdit != null)
            {
                ...
                {
                    case FormWindowState.Normal: plEdit.Show(); break;
                    case FormWindowState.Minimized: plEdit.Hide(); break;
                }
            }
        }

...
namespace Azure.LibCollection.CS.AudioWorks
{
    public static class FireWorks
    {
        ...
        public static void Init(ref System.Windows.Forms.PictureBox g, Rectangle rectangle)
        {
            _graphicsB = g;
            _rect = rectangle;
            BaseInit();
        ...
        public static void Init(ref System.Windows.Forms.PictureBox g, Rectangle rectangle, int timerInterval)
        {
        ...
        public static Image GetImage(int channel /*= 0*/)
        {

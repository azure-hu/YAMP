...
namespace Cyotek.Windows.Forms
{
    ...
    public partial class ColorPickerDialog : Form
    {
        ...
        public ColorPickerDialog(Form owner = null)
        {
        ...
        private void previewPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (this.Color.A != 255)
            {
                if (_textureBrush == null)
                {
                    using (Bitmap background = new Bitmap(this.GetType().Assembly.GetManifestResourceStream("Azure.LibCollection.CS.Controls.CyotekColorPicker.Resources.cellbackground.png")))
                    {

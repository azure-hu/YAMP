    ...
    protected override void OnMouseDown(MouseEventArgs e)
    {
      ...
      if (e.Button == MouseButtons.Left && !this.IsCapturing)
      {
        if (_eyedropperCursor == null)
        {
          ...
          _eyedropperCursor = new Cursor(this.GetType().Assembly.GetManifestResourceStream("Azure.LibCollection.CS.Controls.CyotekColorPicker.Resources.eyedropper.cur"));
        }

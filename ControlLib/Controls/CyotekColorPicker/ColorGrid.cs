...
namespace Cyotek.Windows.Forms
{
  ...
  public class ColorGrid : Control, IColorEditor
  {
    ...
    protected virtual Brush CreateTransparencyBrush()
    {
      ...
      using (Bitmap background = new Bitmap(type.Assembly.GetManifestResourceStream("Azure.LibCollection.CS.Controls.CyotekColorPicker.Resources.cellbackground.png")))
      {

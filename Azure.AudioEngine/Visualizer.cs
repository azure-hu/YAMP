...
namespace Azure.MediaUtils
{
	public class Visualizer
	{
        ...
        public enum VisualItem { Background, Base, Peak, Hold }
        private Visuals vs;
        ...
        [Obsolete("Use GetColor(VisualItem param) instead.")]
        public Color GetColor(string param)
        {
            switch (param)
            {
                case "base": return GetColor(VisualItem.Base);
                case "peak": return GetColor(VisualItem.Peak);
                case "hold": return GetColor(VisualItem.Hold);
                case "back": return GetColor(VisualItem.Background);
                default: throw new Exception("Undefined Parameter!");
            }
        }

        public Color GetColor(VisualItem param)
        {
            switch (param)
            {
                case VisualItem.Base: return _base;
                case VisualItem.Peak: return _peak;
                case VisualItem.Hold: return _hold;
                case VisualItem.Background: return _back;
                default: throw new Exception("Undefined Parameter!");
            }
        }

        public void SetColor(VisualItem param, Color value)
        {
            switch (param)
            {
                case VisualItem.Base: _base = value; break;
                case VisualItem.Peak: _peak = value; break;
                case VisualItem.Hold: _hold = value; break;
                case VisualItem.Background: _back = value; break;
                default: throw new Exception("Undefined Parameter!");
            }
        }
